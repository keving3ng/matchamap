        ...
        <div className="px-4 py-8 space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-md border-2 border-green-100 p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-start gap-3">
                  <Palette size={20} className="text-gray-600 mt-0.5" />
                  <div>
          ...
          <div className="bg-white rounded-2xl shadow-md border-2 border-green-100 p-6">
            ...
            <div className="mt-4 pt-4 border-t border-gray-200 space-y-2">
              <button className="w-full text-left text-green-600 hover:text-green-700 font-semibold">
                Terms of Service
              </button>
              <button className="w-full text-left text-green-600 hover:text-green-700 font-semibold">
                Contact Support
          ...
          <div className="bg-red-50 rounded-2xl shadow-md border-2 border-red-200 p-6">
            ...
            <div className="space-y-3">
              <button className="w-full px-4 py-3 bg-white border-2 border-red-200 text-red-600 rounded-lg hover:bg-red-50 transition font-semibold flex items-center justify-center gap-2">
                <LogOut size={18} />
                Sign Out
              </button>
              <button className="w-full px-4 py-3 bg-white border-2 border-red-300 text-red-700 rounded-lg hover:bg-red-50 transition font-semibold">
                Delete Account
              </button>
            </div>
          </div>
