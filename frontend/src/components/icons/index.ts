 ...
 * 
 * Import icons individually to ensure Vite can tree-shake unused icons.
 * This reduces lucide-react from ~200KB to only the icons we actually use.
 * 
 * Export format: `export { IconName } from 'lucide-react'`
 * Usage: `import { IconName } from '@/components/icons'`
 */

// Core icons (used across multiple components)
