...
import { MapPin, Navigation, Crosshair, Coffee, Star, Building2, ChevronDown, Route, Instagram, X } from '@/components/icons'
  ...
  return (
    <div className="flex-1 relative">
      ...
      <div className="absolute top-4 left-4 right-4 z-[1003]">
        <div className="flex gap-1 overflow-x-auto scrollbar-hide pb-0.5 items-center">
          ...
          <div className="relative flex-shrink-0">
            <button
              ...
              className="px-2.5 py-0.5 leading-tight rounded-lg text-[11px] font-semibold shadow-xs transition-all flex items-center gap-0.5 bg-gradient-to-r from-matcha-600 to-matcha-500 text-white whitespace-nowrap"
            >
              <Building2 size={11} />
          ...
          <div className="relative flex-shrink-0">
            <button
              ...
              className={`px-2.5 py-0.5 leading-tight rounded-lg text-[11px] font-semibold shadow-xs transition-all flex items-center gap-0.5 whitespace-nowrap max-w-[140px] ${
          ...
          {[7, 8, 9].map(rating => (
            <button
              ...
              className={`px-2.5 py-0.5 leading-tight rounded-lg text-[11px] font-semibold transition-all shadow-xs flex-shrink-0 whitespace-nowrap ${
                minRating === rating
                  ? 'bg-gradient-to-r from-matcha-600 to-matcha-500 text-white'
                  : 'bg-white text-gray-700 hover:bg-gray-50'
              }`}
          ...
          {hasActiveQuickFilters && (
            <button
              type="button"
              aria-label={COPY.map.clearFilters}
              onClick={e => {
                e.stopPropagation()
                clearQuickFilters()
              }}
              className="px-2.5 py-0.5 leading-tight rounded-lg text-[11px] font-semibold shadow-xs transition-all flex-shrink-0 flex items-center justify-center bg-white text-gray-700 hover:bg-gray-50"
            >
