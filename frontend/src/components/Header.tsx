      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          {currentView === 'detail' && (
            <button
              ...
              className="p-2 hover:bg-matcha-700 rounded-lg transition-colors duration-200"
          ...
          <button
            onClick={() => navigate('/')}
            className="flex items-center gap-2 hover:bg-matcha-700 rounded-lg px-2 py-1 transition-colors duration-200"
          >
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="p-2 hover:bg-green-700 rounded-lg transition-colors duration-200 flex items-center justify-center"
