  ...
  return (
    <div className="flex-1 overflow-y-auto pb-24">
      ...
      <div className="bg-white border-b-2 border-green-200 px-4 py-4 shadow-sm">
        ...
        <p className="text-sm text-gray-600 mt-1">Access your Matcha Passport and favorites</p>
      </div>
        ...
        <div className="px-4 py-8">
          ...
          <div className="bg-white rounded-2xl shadow-md border-2 border-green-100 p-6">
            <div className="flex items-center justify-center mb-6">
              <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center text-4xl shadow-md">
                🍵
              </div>
            </div>
            ...
            <div className="space-y-3">
              <button
                type="button"
                className="w-full bg-white border-2 border-gray-200 text-gray-700 py-3 rounded-xl font-semibold hover:bg-gray-50 transition flex items-center justify-center gap-2"
              >
