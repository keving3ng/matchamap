...
-   **React Compiler** (Babel) optimizes re-renders automatically; keep following the Rules of React. Prefer relying on the compiler over manual `React.memo` / `useMemo` / `useCallback`—see [docs/REACT_COMPILER.md](docs/REACT_COMPILER.md)
